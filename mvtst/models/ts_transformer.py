...
class NonBreakingFixedPositionalEncoding(nn.Module):
    # For use with distributed lightning
    # Ref: https://github.com/pytorch/pytorch/issues/68407

    def __init__(self, d_model, dropout=0.1, max_len=1024):
        super(NonBreakingFixedPositionalEncoding, self).__init__()
...
def get_pos_encoder(pos_encoding):
    if pos_encoding == "learnable":
        ...
        return NonBreakingFixedPositionalEncoding
